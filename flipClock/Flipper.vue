<template>
  <view class="M-Flipper" :class="[flipType, {'go': isFlipping}]">
    <view class="digital front" :class="'number' + frontTextFromData"></view>
    <view class="digital back" :class="'number' + backTextFromData"></view>
  </view>
</template>
